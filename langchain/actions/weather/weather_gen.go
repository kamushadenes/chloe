...
// This file was generated at 2023-09-21 13:57:46.185343 -0300 -03 m=+0.011727334
package weather
...
// NewWeatherAction creates a new WeatherAction with Params initialized
func NewWeatherAction() action_structs.Action {
...
func (a *WeatherAction) SkipFunctionCall() bool {
	return false
}

// CheckRequiredParams checks if all required params are set
func (a *WeatherAction) CheckRequiredParams() error {
	return a.Params.CheckRequiredParams()
}
func (a *WeatherAction) GetName() string {
	return a.Name
}
func (a *WeatherAction) GetDescription() string {
	return a.Description
}
func (a *WeatherAction) SetParam(key, value string) {
	a.Params.SetParam(key, value)
}
func (a *WeatherAction) GetParam(key string) (string, error) {
...
func (a *WeatherAction) MustGetParam(key string) string {
	v, _ := a.GetParam(key)
	return v
}
func (a *WeatherAction) GetParams() []*action_structs.ActionParameter {
	return a.Params.GetParams()
}
func (a *WeatherAction) SetMessage(msg *memory.Message) {}
func (a *WeatherAction) RunPreActions(request *action_structs.ActionRequest) error {
	return errors.ErrNotImplemented
}
func (a *WeatherAction) RunPostActions(request *action_structs.ActionRequest) error {
	return errors.ErrNotImplemented
}

func (a *WeatherAction) GetSchema() *functions.FunctionDefinition {
